 ...
 * Author: 1_1
 */
public class RocketPodRenderer extends EntityRenderer<RocketPodEntity>
{
    ...
    public RocketPodRenderer(EntityRendererProvider.Context context)
    {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(RocketPodEntity entity)
    {
        return null;
    }

    @Override
    public void render(RocketPodEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource renderTypeBuffer, int light)
    {
