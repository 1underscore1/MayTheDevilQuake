 ...
 */
@OnlyIn(Dist.CLIENT)
public class LaserRingParticle extends TextureSheetParticle
{
    public LaserRingParticle(ClientLevel world, double x, double y, double z)
    {
    ...
    */
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType>
    {
        ...
        {
            LaserRingParticle particle = new LaserRingParticle(worldIn, x, y, z);
